    ...
    public static void generateHTMLERRORES() {
     ...
     public static void generarTablaSimbolos() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("Reporte de Errores.html"))) {
            ...
            writer.write("<th>VARIABLE</th>\n");
            writer.write("<th>TIPO</th>\n");
            writer.write("<th>VALOR</th>\n");
            writer.write("</tr>\n");
            int contador = 1;
            for (Map.Entry<String, sim> entry : Analizadores.Parser.hashMap.entrySet()) {
                sim simbolo = entry.getValue();
                writer.write("<tr>\n");
                writer.write("<td>" + contador + "</td>\n");
                writer.write("<td>" + entry.getKey() + "</td>\n");
                writer.write("<td>" + simbolo.getTipo() + "</td>\n");
                writer.write("<td>" + simbolo.obtenerValorNoNulo()+ "</td>\n");
                contador ++;
